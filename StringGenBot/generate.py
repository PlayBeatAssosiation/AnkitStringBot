...
async def generate_session(bot: Client, msg: Message, telethon=False, old_pyro: bool = False, is_bot: bool = False):
    ...
    if not is_bot:
        ...
        try:
            ...
            try:
                two_step_msg = await bot.ask(user_id, "» ʟᴏᴡᴅᴇ **ᴛᴡᴏ sᴛᴇᴩ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ** ᴩᴀssᴡᴏʀᴅ ᴛᴇʀᴀ ʙᴀᴀᴘ ᴅᴀʟᴇɢᴀ 😒 ᴀʏʏᴀ ʙᴀᴅᴅᴀ ᴘʀɪᴠᴀᴄʏ ᴋᴀᴀ ᴄʜᴏᴅᴀ.", filters=filters.text, timeout=300)
            except TimeoutError:
    ...
    text = f"**ᴛʜɪs ɪs ʏᴏᴜʀ {ty} sᴛʀɪɴɢ sᴇssɪᴏɴ** \n\n`{string_session}` \n\n**ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ :** @AnkitStringBot\n🍒 **ɴᴏᴛᴇ :** ᴅᴏɴ'ᴛ sʜᴀʀᴇ ɪᴛ ᴡɪᴛʜ ʏᴏᴜʀ ɢɪʀʟғʀɪᴇɴᴅ 🍑 ᴀɴᴅ ᴅᴏɴ'ᴛ ғᴏʀɢᴇᴛ ᴛᴏ sᴜᴘᴘᴏʀᴛ @NoMoreAnkit 🥺"
    try:
        if not is_bot:
